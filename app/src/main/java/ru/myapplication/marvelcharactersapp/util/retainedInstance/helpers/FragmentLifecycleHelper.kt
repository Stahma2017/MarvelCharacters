...
class FragmentLifecycleHelper(private val onFragmentDestroyed: ((fragment: Fragment) -> Unit)?) : FragmentManager.FragmentLifecycleCallbacks() {
    ...
    override fun onFragmentPreAttached(fm: FragmentManager, f: Fragment, context: Context) {
        ...
        when {
            ...
            args.getString(CONTAINER_UUID) == null -> args.putString(CONTAINER_UUID, UUID.randomUUID().toString())
        }
